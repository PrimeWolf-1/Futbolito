...
- [ ] **1. HTML scaffold + screen controller + GitHub repo**
...
- [ ] **2. Physics engine + board canvas render**
...
- [ ] **5. Goal detection + scoreboard update**
